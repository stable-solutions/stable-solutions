...
const ContactUsPage = () => {
    ...
    const contactUsContent = [
        ...
        {
            type: 'section',
            title: t('contact.generalInfoTitle'),
            content: t('contact.generalInfoContent'),
        },
        {
            type: 'section',
            title: t('contact.supportTitle'),
            content: t('contact.supportContent'),
        },
        {
            type: 'section',
            title: t('contact.feedbackTitle'),
            content: t('contact.feedbackContent'),
        },
        // {
        //     type: 'image',
        //     title: t('contact.contactImageTitle'),
        //     text: t('contact.contactImageText'),
        //     image: t('contact.contactImage'),
        // },
    ...
    return (
        <div className="flex flex-col">
            <div className="relative min-h-[60vh] flex flex-col items-center justify-center bg-gradient-to-b from-red-100 to-yellow-100 p-4 sm:p-8 text-center overflow-hidden">
                ...
                />
                {renderContent(contactUsContent[0], 0)}
            </div>

            <div className="p-4 sm:p-8 max-w-4xl mx-auto w-full">
                {contactUsContent.slice(1).map((item, index) => renderContent(item, index + 1))}
            </div>

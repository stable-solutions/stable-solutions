...
const HeroSection: React.FC = () => (
    <div className="relative h-[90vh] pt-40 pb-32 flex flex-col items-start justify-center bg-pale-blue text-left overflow-hidden px-10"> {/* Adjusted top padding */}
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between w-full">
            {/* Text Section */}
            <div className="flex flex-col items-start w-full md:w-1/2 space-y-4"> {/* Adjusted spacing */}
                <h1
                    className="text-4xl sm:text-5xl md:text-6xl font-poppins font-extrabold text-dark-blue leading-snug md:leading-normal"  // Increased line height
                >
                ...
                <p
                    className="text-xl md:text-2xl text-dark-blue mt-6"
                >
            ...
            <img
                ...
                alt="rocket-hero"
                className="w-full max-w-[600px] h-auto md:max-w-[600px] mt-8 md:mt-0 md:ml-6"  // Slightly smaller image size
            />
        </div>
    </div>
);

...
const HeroSection: React.FC = () => (
  <div className="relative h-[90vh] bg-pale-blue flex justify-center items-center overflow-hidden">
    {/* Wrapper with scaling and centered content */}
    <div
      className="transform scale-75" // This scales the entire hero section down to 75% size
      style={{ width: '100%', height: '100%', maxWidth: '100%' }}
    >
      <div className="relative h-full pt-40 pb-32 flex flex-col items-start justify-center text-left px-10">
        ...
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between w-full">
          ...
          <div className="flex flex-col items-start w-full md:w-1/2 space-y-4">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-poppins font-extrabold text-dark-blue leading-snug md:leading-normal">
              Elevate your Digital Professionalism with{' '}
              <span className="text-dark-blue">Stable</span>{' '}
              <span className="text-olive-green">Solutions</span>
            </h1>
            <p className="text-xl md:text-2xl text-dark-blue mt-6">
              Find solutions that align with your business goals and ensure

...
const FeaturesSection: React.FC = () => (
    <div className="bg-off-white py-16 px-4 sm:px-8">
        <div className="max-w-6xl mx-auto">
            {/* Main Heading */}
            <div className="w-full md:w-3/5">  {/* 3/5 width for header */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">  {/* Full width grid layout */}
                {/* Custom AI Tools */}
                <div className="flex items-start space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-lg font-roboto text-dark-blue leading-normal">
                            ...
                            Together we can find how we can use AI to make your life easier.
                        </p>
                    </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-lg font-roboto text-dark-blue leading-normal">
                            Our team can help you blend the aesthetic with the technology, delivering stunning websites 
                            and engaging apps! See your brand like never before.
                        </p>
                    </div>
                </div>

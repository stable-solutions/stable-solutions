    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="flex items-start space-x-4">
          ...
          <div>
            <h2 className="text-2xl md:text-2xl font-poppins font-bold text-dark-blue mb-2">Custom AI Tools</h2>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            <h2 className="text-2xl md:text-2xl font-poppins font-bold text-dark-blue mb-2">Creative Design</h2>
            <p className="text-lg font-roboto text-dark-blue leading-normal">
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            <h2 className="text-2xl md:text-2xl font-poppins font-bold text-dark-blue mb-2">Digital Full Service</h2>
            <p className="text-lg font-roboto text-dark-blue leading-normal">
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            <h2 className="text-2xl md:text-2xl font-poppins font-bold text-dark-blue mb-2">Relationship Forward</h2>
            <p className="text-lg font-roboto text-dark-blue leading-normal">

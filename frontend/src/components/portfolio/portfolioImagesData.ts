export const portfolioImages = [
  {
    src: '/assets/portfolio/portfolio-images/portfolioimage-Buri.png',
    fullSizeSrc: '/assets/portfolio/portfolio-images/portfolioimage-Buri.png',
    alt: 'Buri - Modern Restaurant',
    title: 'Buri - Modern Restaurant',
    description: 'A modern restaurant located at the heart of the city offering exquisite dishes.',
    shortName: 'buri'
  },
  {
  ...
  {
    src: '/assets/portfolio/portfolio-images/portfolioimage-cloudbasedservices.png',
    fullSizeSrc: '/assets/portfolio/portfolio-images/portfolioimage-cloudbasedservices.png',
    alt: 'Cloud Based Services',
    title: 'Cloud Based Services',
    description: 'Comprehensive cloud-based solutions for modern businesses.',
    shortName: 'cloudBaseServices'
  },
  {
    src: '/assets/portfolio/portfolio-images/portfolioimage-cloudbasedtaxes.png',
    fullSizeSrc: '/assets/portfolio/portfolio-images/portfolioimage-cloudbasedtaxes.png',
    alt: 'Cloud Based Tax Software',
    title: 'Cloud Based Tax Software',
    description: 'Efficient cloud-based tax preparation and filing services.',
    shortName: 'cloudBaseTaxes'
  },
  {
  ...
  {
    src: '/assets/portfolio/portfolio-images/portfolioimage-HomeImprovementsEquipment.png',
    fullSizeSrc: '/assets/portfolio/portfolio-images/portfolioimage-HomeImprovementsEquipment.png',
    alt: 'Home Improvement Equipment',
    title: 'Home Improvement Equipment',
    description: 'Tools and equipment for all your home improvement needs.',
    shortName: 'homeImprovementEquipment'
  },
  {

...
const AboutSection: React.FC = ()  => (
    ...
    >
        ...
        <div className="flex flex-col items-start w-full space-y-3">
            <h2 className="text-olive-green text-3xl sm:text-3xl md:text-2xl font-poppins font-extrabold mb-8 md:ml-20">About Us</h2> {/* Scaled down the font size */}
        ...
        <img
            ...
            className="w-[80%] sm:w-[60%] md:w-[50%] h-auto mt-8 md:mr-20 md:mt-0 md:ml-8 rounded-lg item-start" // Scaled image based on screen size
        />
    </section>
);
